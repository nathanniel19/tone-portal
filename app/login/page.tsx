...
export default function LoginPage() {
  ...
  return (
    // Background utama dengan gradasi halus
    <div className="flex min-h-screen items-center justify-center bg-gradient-to-br from-slate-900 via-blue-900 to-slate-900 px-4">
      ...
      <div className="w-full max-w-md bg-white/10 backdrop-blur-lg border border-white/20 p-8 rounded-2xl shadow-2xl">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-blue-200 mt-2">Silakan login untuk akses database</p>
        </div>

        {/* Form Section */}
        <form onSubmit={handleLogin} className="space-y-5">
          <div>
            <label className="block text-sm font-medium text-blue-100 mb-1 ml-1">Username</label>
            <input 
              type="text" 
              required
              placeholder="admin" 
          ...
          <div>
            <label className="block text-sm font-medium text-blue-100 mb-1 ml-1">Password</label>
            <input 
              type="password" 
              required
              placeholder="••••••••" 
